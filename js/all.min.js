	...
	function(){
		...
		function h(m,n){
			if(m.classList){
				...
				if(f(m,n)==false){
					var l=m.className;if(l.length>0){l+=" "}m.className=l+n
				}
			}
		}
		function a(m,n){
		...
		function c(l,o){
			if(document.createEvent){
				...
				for(var m in o){
					n[m]=o[m]}document.dispatchEvent(n)
				}
			}
			function b(m,l){
				var o;
    		...
    		return{
    			addListener:k,dispatchEvent:c,testCSS:g,getPrefixed:j,typeOf:e,addClass:h,removeClass:a,hasClass:f,distance:b
    		}
    	}
)();
/*!
			...
			function(){
				...
				function ba(){
					...
					for(var b2=0;b2<bN.length;b2++){
						...
						bK+=pages.length;bZ=Math.max(bZ,pages.length);
						for(var b3=0;b3<pages.length;b3++){
							...
							b1.index=b3;b1.setAttribute("id","");
						...
						var aR=(
							...
							function aZ(a8){
								if(a8.length>0){
									...
									if(ba!=null){var a9=null;
										if(e.length>1){a9=ba.querySelector(aK+"[data-id=__"+e[1]+"]")||ba.querySelector(aK+"[data-prog=__"+e[1]+"]")
									}if(a9==null){
